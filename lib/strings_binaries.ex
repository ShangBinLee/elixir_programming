defmodule StringsBinaries do
  ...
  ## 例
      ...
      iex> StringsBinaries.calculate(~c'2 + 5')
      7
      iex> StringsBinaries.calculate(~c'123 + 27')
      150
      iex> StringsBinaries.calculate(~c'100 - 150')
      -50
      iex> StringsBinaries.calculate(~c'200 * 12')
      2400
      iex> StringsBinaries.calculate(~c'100 / 22')
      4.545454545454546

      iex> StringsBinaries.calculate(~c'5')
      ** (FunctionClauseError) no function clause matching in StringsBinaries._calculate/1

      iex> StringsBinaries.calculate(~c'5 * 5+5')
      ** (FunctionClauseError) no function clause matching in StringsBinaries._calculate/1

      iex> StringsBinaries.calculate(~c'55 5')
      ** (FunctionClauseError) no function clause matching in StringsBinaries._calculate/1
      ...
      ** (RuntimeError) 演算子を入力してください
      ...
      iex> StringsBinaries.calculate(~c'2 * ')
